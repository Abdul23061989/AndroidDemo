...
public class MainActivity extends AuthenticatedActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    protected void onResume()
    {
        ...
        if (!isAuthenticated()) {
            ...
            Snackbar.make(drawer,"User Successfully Logged in", Snackbar.LENGTH_LONG).show();
    ...
    public boolean isServicesOK(){
        ...
        if(available == ConnectionResult.SUCCESS){return true;}
            ...
            dialog.show();}
            else{ Toast.makeText(this, "Can't make map requests", Toast.LENGTH_SHORT).show(); }
        return false;}
